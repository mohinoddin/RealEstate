    ...
    return (
        <form class='form-container'>
            <label for='length'> Length <br/>
                <input type='text' id='length' name='length' placeholder='Example: 1000' onChange={(e) => {handleFormData(e)}} class='input'/>
            </label><br/>

            <label for='breadth'> Breadth <br/>
                <input type='text' id='breadth' name='breadth' placeholder='Example: 1000' onChange={(e) => {handleFormData(e)}} class='input'/>
            </label><br/>

            <label for='totalArea'>Total Area <br/>
                <input type='text' id='totalArea' name='totalArea' placeholder='Example: 7500' onChange={(e) => {handleFormData(e)}} class='input'/>
            </label><br/>

            <label for='areaUnit'>Area Unit <br/>
                <input type='text' id='areaUnit' name='areaUnit' placeholder='Area Unit' onChange={(e) => {handleFormData(e)}} class='input'/>
            </label><br/>
            ...
            <label for='electricity'>Electricity <br/>
                <input type='text' id='electricity' name='electricity' placeholder='Example: 3 Phase' onChange={(e) => {handleFormData(e)}} class='input'/>
            </label><br/>
